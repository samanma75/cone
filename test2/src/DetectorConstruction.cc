...
//Definition of cone geometry
G4Cons* Cons1 = new G4Cons("Cons1", 0 * cm, 0 * cm, 20 * cm, 30 * cm, 30 * cm, 0 * deg, 360* deg);
G4LogicalVolume* LCons1 = new G4LogicalVolume(Cons1, mat2, "Cons1");
new G4PVPlacement(0, G4ThreeVector(0*cm,0*cm,50*cm), LCons1, "Cons1", LBox, false, 0);
